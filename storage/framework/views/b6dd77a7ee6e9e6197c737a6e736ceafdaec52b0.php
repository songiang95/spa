  ...
  <div class="container">
        ...
        <div class="about-product"> <!-- Thông tin về sản phẩm -->
            <div id="product-name">
                    ...
                    <h2> Tên Dịch Vụ: <?php echo e($dichVu->ten_dichvu); ?> </h2>
                <div id="status">
                    <span>Tình Trạng:</span> <?php if($spKhuyenMai->tinhtrang_km == 1): ?>
                                        Còn khuyến mại
                                        <?php else: ?> 
                                        Hết khuyến mại
                                        <?php endif; ?>
        ...
        <div class="product-description"><!-- Mô tả sản phẩm -->
            <p><?php echo e($spKhuyenMai->noidung_km); ?></p>
        </div> 
